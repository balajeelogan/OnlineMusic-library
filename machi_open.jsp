...
<html>
    ...
    <body>
    <marquee><h1>Machi Open the Bottle</h1></marquee>
    <img src="images/Yuvan.jpg"/><br>
    <p>
      <b>
      Movie:Mankatha<br><br>
      Song:Machi_Open_the_Bottle<br><br> 
      Composer:Yuvan<br><br>
      Singer:Kailash Kher, D. Sathyaprakash, Deepak, Pooja AV<br><br>     
      KBPS:320_kbps</b>
    </p>
        <audio controls>
            <source src="Songs/Machi_Open_The_Bottle.mp3" type="audio/mpeg">
